...
public:
	static std::string getBasisName(){
		return std::string("tp1linear");
	}
	static const O M(const I &x, const I &y) { return (O)bspline1(x)*bspline1(y); };
	static const O M(const vector2<I> &p) { return (O)bspline1(p.i)*bspline1(p.j); };
	...
	static std::vector<std::tuple<int,int,O>> getBeppoLevi2Norm() {
		using namespace std;

		return {make_tuple(-3, -3, 13./317520.), make_tuple(-3, -2, 1./756.),  make_tuple(-3, -1, 641./105840.), make_tuple(-3, 0, 178./19845.), 
				 make_tuple(-3, 1, 641./105840.),  make_tuple(-3, 2, 1./756.), make_tuple(-3, 3, 13./317520.),  make_tuple(-2, -3, 1./756.), 
				 make_tuple(-2, -2, 8./441.),  make_tuple(-2, -1, 11./1764.), make_tuple(-2, 0, -68./1323.), make_tuple(-2, 1, 11./1764.),  make_tuple(-2, 2, 8./441.), 
				 make_tuple(-2, 3, 1./756.),  make_tuple(-1, -3, 641./105840.), make_tuple(-1, -2, 11./1764.),  make_tuple(-1, -1, -3323./35280.), 
				 make_tuple(-1, 0, -334./6615.), make_tuple(-1, 1, -3323./35280.), make_tuple(-1, 2, 11./1764.),  make_tuple(-1, 3, 641./105840.), 
				 make_tuple(0, -3, 178./19845.),  make_tuple(0, -2, -68./1323.), make_tuple(0, -1, -334./6615.),  make_tuple(0, 0, 11248./19845.), 
				 make_tuple(0, 1, -334./6615.),  make_tuple(0, 2, -68./1323.), make_tuple(0, 3, 178./19845.),  make_tuple(1, -3, 641./105840.), 
				 make_tuple(1, -2, 11./1764.),  make_tuple(1, -1, -3323./35280.), make_tuple(1, 0, -334./6615.), make_tuple(1, 1, -3323./35280.), 
				 make_tuple(1, 2, 11./1764.),  make_tuple(1, 3, 641./105840.), make_tuple(2, -3, 1./756.),  make_tuple(2, -2, 8./441.), 
				 make_tuple(2, -1, 11./1764.),  make_tuple(2, 0, -68./1323.), make_tuple(2, 1, 11./1764.),  make_tuple(2, 2, 8./441.), 
				 make_tuple(2, 3, 1./756.),  make_tuple(3, -3, 13./317520.), make_tuple(3, -2, 1./756.),  make_tuple(3, -1, 641./105840.), 
				 make_tuple(3, 0, 178./19845.),  make_tuple(3, 1, 641./105840.), make_tuple(3, 2, 1./756.),  make_tuple(3, 3, 13./317520.)};
	}
	static std::vector<std::tuple<int,int,O>> getBeppoLevi1Norm(){throw "basis_function()::getBeppoLevi1Norm() - Not Implemented!";};
	static std::vector<std::tuple<int,int,O>> autoCorrelation(){
		using namespace std;
		return  {make_tuple(-3, -3, 1./25401600.),  make_tuple(-3, -2, 1./211680.), 
			  make_tuple(-3, -1, 397./8467200.),  make_tuple(-3, 0, 151./1587600.), 
			  make_tuple(-3, 1, 397./8467200.),  make_tuple(-3, 2, 1./211680.), 
			  make_tuple(-3, 3, 1./25401600.),  make_tuple(-2, -3, 1./211680.), 
			  make_tuple(-2, -2, 1./1764.),   make_tuple(-2, -1, 397./70560.), 
			  make_tuple(-2, 0, 151./13230.),  make_tuple(-2, 1, 397./70560.), 
			  make_tuple(-2, 2, 1./1764.),   make_tuple(-2, 3, 1./211680.), 
			  make_tuple(-1, -3, 397./8467200.),  make_tuple(-1, -2, 397./70560.), 
			  make_tuple(-1, -1, 157609./2822400.),   make_tuple(-1, 0, 59947./529200.), 
			  make_tuple(-1, 1, 157609./2822400.),   make_tuple(-1, 2, 397./70560.), 
			  make_tuple(-1, 3, 397./8467200.),   make_tuple(0, -3, 151./1587600.), 
			  make_tuple(0, -2, 151./13230.),   make_tuple(0, -1, 59947./529200.), 
			  make_tuple(0, 0, 22801./99225.),   make_tuple(0, 1, 59947./529200.), 
			  make_tuple(0, 2, 151./13230.), make_tuple(0, 3, 151./1587600.), 
			  make_tuple(1, -3, 397./8467200.),  make_tuple(1, -2, 397./70560.), 
			  make_tuple(1, -1, 157609./2822400.),   make_tuple(1, 0, 59947./529200.), 
			  make_tuple(1, 1, 157609./2822400.),   make_tuple(1, 2, 397./70560.), 
			  make_tuple(1, 3, 397./8467200.),   make_tuple(2, -3, 1./211680.), 
			  make_tuple(2, -2, 1./1764.),   make_tuple(2, -1, 397./70560.), 
			  make_tuple(2, 0, 151./13230.),   make_tuple(2, 1, 397./70560.), 
			  make_tuple(2, 2, 1./1764.),   make_tuple(2, 3, 1./211680.), 
			  make_tuple(3, -3, 1./25401600.),   make_tuple(3, -2, 1./211680.), 
			  make_tuple(3, -1, 397./8467200.),  make_tuple(3, 0, 151./1587600.), 
			  make_tuple(3, 1, 397./8467200.),   make_tuple(3, 2, 1./211680.), 
			  make_tuple(3, 3, 1./25401600.)};
	}
	...
	static O poissonFilter(const I &u, const I &v, const I &h) {
		O invh = 1./(h*h);
		O lambda = (2./3.)*
	...
	static O divgradFilter(const I &u, const I &v, const I &h) {
		O invh = 1./(h*h);
		O lambda = (2./3.)*
							( invh*(-7. + cos(u))*sin(0.5*u)*sin(0.5*u) +
								invh*(-7. + cos(v))*sin(0.5*v)*sin(0.5*v));
...
{make_tuple(-3, -3, 13./317520.), make_tuple(-3, -2, 1./756.), 
 make_tuple(-3, -1, 641./105840.), make_tuple(-3, 0, 178./19845.), 
 make_tuple(-3, 1, 641./105840.),  make_tuple(-3, 2, 1./756.), 
 make_tuple(-3, 3, 13./317520.),  make_tuple(-2, -3, 1./756.), 
 make_tuple(-2, -2, 8./441.),  make_tuple(-2, -1, 11./1764.), 
 make_tuple(-2, 0, -68./1323.), make_tuple(-2, 1, 11./1764.),  make_tuple(-2, 2, 8./441.), 
 make_tuple(-2, 3, 1./756.),  make_tuple(-1, -3, 641./105840.), 
 make_tuple(-1, -2, 11./1764.),  make_tuple(-1, -1, -3323./35280.), 
 make_tuple(-1, 0, -334./6615.), make_tuple(-1, 1, -3323./35280.), 
 make_tuple(-1, 2, 11./1764.),  make_tuple(-1, 3, 641./105840.), 
 make_tuple(0, -3, 178./19845.),  make_tuple(0, -2, -68./1323.), 
 make_tuple(0, -1, -334./6615.),  make_tuple(0, 0, 11248./19845.), 
 make_tuple(0, 1, -334./6615.),  make_tuple(0, 2, -68./1323.), 
 make_tuple(0, 3, 178./19845.),  make_tuple(1, -3, 641./105840.), 
 make_tuple(1, -2, 11./1764.),  make_tuple(1, -1, -3323./35280.), 
 make_tuple(1, 0, -334./6615.), make_tuple(1, 1, -3323./35280.), 
 make_tuple(1, 2, 11./1764.),  make_tuple(1, 3, 641./105840.), 
 make_tuple(2, -3, 1./756.),  make_tuple(2, -2, 8./441.), 
 make_tuple(2, -1, 11./1764.),  make_tuple(2, 0, -68./1323.), 
 make_tuple(2, 1, 11./1764.),  make_tuple(2, 2, 8./441.), 
 make_tuple(2, 3, 1./756.),  make_tuple(3, -3, 13./317520.), 
 make_tuple(3, -2, 1./756.),  make_tuple(3, -1, 641./105840.), 
 make_tuple(3, 0, 178./19845.),  make_tuple(3, 1, 641./105840.), 
 make_tuple(3, 2, 1./756.),  make_tuple(3, 3, 13./317520.)}
